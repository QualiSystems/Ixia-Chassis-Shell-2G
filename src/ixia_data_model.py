...
class Ixia_Chassis_Shell_2G(object):
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['Ixia Chassis Shell 2G.Password'] if 'Ixia Chassis Shell 2G.Password' in self.attributes else None
    ...
    def controller_tcp_port(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixia Chassis Shell 2G.Controller TCP Port'] if 'Ixia Chassis Shell 2G.Controller TCP Port' in self.attributes else None
    ...
    def controller_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixia Chassis Shell 2G.Controller Address'] if 'Ixia Chassis Shell 2G.Controller Address' in self.attributes else None
    ...
    def client_install_path(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixia Chassis Shell 2G.Client Install Path'] if 'Ixia Chassis Shell 2G.Client Install Path' in self.attributes else None
    ...
    def power_management(self):
        ...
        :rtype: bool
        """
        return self.attributes['Ixia Chassis Shell 2G.Power Management'] if 'Ixia Chassis Shell 2G.Power Management' in self.attributes else None
    ...
    def serial_number(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixia Chassis Shell 2G.Serial Number'] if 'Ixia Chassis Shell 2G.Serial Number' in self.attributes else None
    ...
    def server_description(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixia Chassis Shell 2G.Server Description'] if 'Ixia Chassis Shell 2G.Server Description' in self.attributes else None
...
class GenericTrafficGeneratorModule(object):
    ...
    def version(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixia Chassis Shell 2G.GenericTrafficGeneratorModule.Version'] if 'Ixia Chassis Shell 2G.GenericTrafficGeneratorModule.Version' in self.attributes else None
    ...
    def serial_number(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixia Chassis Shell 2G.GenericTrafficGeneratorModule.Serial Number'] if 'Ixia Chassis Shell 2G.GenericTrafficGeneratorModule.Serial Number' in self.attributes else None
...
class GenericTrafficGeneratorPort(object):
    ...
    def media_type(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixia Chassis Shell 2G.GenericTrafficGeneratorPort.Media Type'] if 'Ixia Chassis Shell 2G.GenericTrafficGeneratorPort.Media Type' in self.attributes else None
...
class GenericPowerPort(object):
    ...
    def model(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixia Chassis Shell 2G.GenericPowerPort.Model'] if 'Ixia Chassis Shell 2G.GenericPowerPort.Model' in self.attributes else None
    ...
    def serial_number(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixia Chassis Shell 2G.GenericPowerPort.Serial Number'] if 'Ixia Chassis Shell 2G.GenericPowerPort.Serial Number' in self.attributes else None
    ...
    def version(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixia Chassis Shell 2G.GenericPowerPort.Version'] if 'Ixia Chassis Shell 2G.GenericPowerPort.Version' in self.attributes else None
    ...
    def port_description(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixia Chassis Shell 2G.GenericPowerPort.Port Description'] if 'Ixia Chassis Shell 2G.GenericPowerPort.Port Description' in self.attributes else None
