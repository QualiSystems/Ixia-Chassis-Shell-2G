...
### Standard version
The Ixia Chassis 2G Shell 2.1.2 is based on the Traffic Shell standard *cloudshell_traffic_generator_chassis_standard_1_0_3.yaml*.
...
**Note** This version of Ixia Chassis 2G Shell requires offline installation.   
